				...
				<div class="rswpbs-row">
					<div class="rswpbs-col-md-12">
						<div class="rswpbs-book-showcase-page-title">
							<h1 class="rswpbs-book-category-name<?php echo esc_attr($headingClass ?? ''); ?>">
								<?php echo esc_html($currentCatObj->name ?? ''); ?>
							</h1>
