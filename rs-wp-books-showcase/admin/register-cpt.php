...
class Rswpbs_Register_Book_Post_Type
{
	...
	public function __construct()
	{
		...
		add_action('init', array($this, 'register_book_publisher_taxonomy'));
	 ...
	 */
	public function register_book_publisher_taxonomy()
	{
		$labels = array(
			'name' => _x('Book Publishers', 'Book Publishers', 'rswpbs'),
			'singular_name' => _x('Book Publisher', 'Book Publisher', 'rswpbs'),
			'menu_name' => __('Book Publishers', 'rswpbs'),
			'all_items' => __('All Book Publishers', 'rswpbs'),
			'parent_item' => __('Parent Book Publisher', 'rswpbs'),
			'parent_item_colon' => __('Parent Book Publisher:', 'rswpbs'),
			'new_item_name' => __('New Book Publisher Name', 'rswpbs'),
			'add_new_item' => __('Add New Book Publisher', 'rswpbs'),
			'edit_item' => __('Edit Book Publisher', 'rswpbs'),
			'update_item' => __('Update Book Publisher', 'rswpbs'),
			'view_item' => __('View Book Publisher', 'rswpbs'),
			'separate_items_with_commas' => __('Separate items with commas', 'rswpbs'),
			'add_or_remove_items' => __('Add or remove items', 'rswpbs'),
			'choose_from_most_used' => __('Choose from the most used', 'rswpbs'),
			'popular_items' => __('Popular Book Publishers', 'rswpbs'),
			'search_items' => __('Search Items', 'rswpbs'),
			'not_found' => __('Not Found', 'rswpbs'),
			'no_terms' => __('No items', 'rswpbs'),
			'items_list' => __('Items list', 'rswpbs'),
		...
		$args = array(
			...
			'show_in_menu' => true,
			'capabilities' => array(
				'manage_terms' => 'manage_book_publisher',
				'edit_terms' => 'edit_book_publisher',
				'delete_terms' => 'delete_book_publisher',
				'assign_terms' => 'assign_book_publisher',
			)
		);
		register_taxonomy('book-publisher', array($this->post_type), $args);
	}
	public function book_showcase_custom_column($columns)
	{
		unset(
			...
			$columns['taxonomy-book-publisher'],
		...
		$columns['taxonomy-book-series'] = $columns['taxonomy-book-series'];
		$columns['taxonomy-book-publisher'] = __('Book Publisher', 'rswpbs');
		$columns['taxonomy-book-publisher'] = $columns['taxonomy-book-publisher'];
