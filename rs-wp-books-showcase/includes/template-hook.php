...
function rswpbs_archive_template($template)
{
  ...
  if (is_tax('book-publisher')) {
    $theme_files = array('taxonomy-book-publisher.php', 'rsbs-templates/taxonomy-book-publisher.php');
    $exists_in_theme = locate_template($theme_files, false);
    if ($exists_in_theme != '') {
      return $exists_in_theme;
    } else {
      return RSWPBS_PLUGIN_PATH . 'rsbs-templates/taxonomy-book-publisher.php';
    }
  }
  return $template;
}
