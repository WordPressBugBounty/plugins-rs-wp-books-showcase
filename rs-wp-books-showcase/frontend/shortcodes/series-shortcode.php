...
function rswpbs_series_shortcode_output($atts){
    ...
    <div class="rswpbs-authors-shortcode-wrapper"
         data-per-row="<?php echo esc_attr($atts['series_per_row']); ?>"
        ...
        <div class="rswpbs-author-search">
            <form class="rswpbs-author-search-form">
                <input type="text" name="author_search" placeholder="Search Series..." class="author-search-input">
    ...
    jQuery(document).ready(function($) {
        var offset = <?php echo $atts['series_per_page']; ?>;
        var perPage = <?php echo $atts['series_per_page']; ?>;
...
function rswpbs_get_series_html($atts, $offset, $search = '') {
    $authorsPerRow = $atts['series_per_row'];
