 ...
 * Book Author Page
 */
add_shortcode( 'rswpbs_book_publisher_page', 'rswpbs_book_publisher_page_shortcode' );
function rswpbs_book_publisher_page_shortcode($atts){
